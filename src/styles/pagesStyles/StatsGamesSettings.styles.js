...
export const useStyles = makeStyles({
    ...
    messageArea: (props) => ({
        ...
        cursor:
            props.theme === 'dark'
                ? `url(${icons.darkInput}), text`
                : `url(${icons.lightInput}), text`,
        fontSize: '1rem',
        background: 'inherit',
        border: '1px solid',
    ...
    form: (props) => ({
        ...
        '& .MuiInputBase-root': {
            ...
            '& .MuiOutlinedInput-input': {
                cursor:
                    props.theme === 'dark'
                        ? `url(${icons.darkInput}), default`
                        : `url(${icons.lightInput}), default`,
            },
        },
    }),
    info: {
    ...
    thumb: (props) => ({
        ...
        '&:hover': {
            boxShadow: props.theme
                ? '0px 0px 0px 8px rgb(227, 134, 0, 0.2)'
                : '0px 0px 0px 8px rgb(85, 0, 232, 0.2)',
        },
    }),
    active: {},
    valueLabel: (props) => ({
