...
export const MAIN_PAGE_TEXT = {
    TITLE: 'RS Lang',
    SUBTITLE: 'Играй, учи и разговаривай на английском',
    P1: 'RS Lang — это эффективный сервис для увлекательной практики языков. Более 23 000 000 человек во всем мире уже с нами. Присоединяйся!',
    P2: 'Мы решаем главную проблему изучающих иностранный язык — поддерживаем мотивацию.',
    P3: 'Наши пользователи изучают английский и другие иностранные языки по аутентичным материалам на языке оригинала (фильмы, музыка, книги), проходят увлекательные тренировки для закрепления словарного запаса, осваивают курсы под свои цели (для работы, общения, путешествий), выполняют задания и следят за своим прогрессом.',
    P4: 'RS Lang — мультиплатформенный сервис. Сейчас он доступен на веб-платформе, а скоро и в виде бесплатных мобильных приложений для iOS, Android, веерных сеялок и расширений для браузеров.',
}
