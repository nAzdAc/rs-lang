...
export function updateUserWord(object, token) {
    return async (dispatch) => {
        ...
        try {
            ...
            dispatch(isBlock(false))
            return {
                text: 'Возникла проблема с изменением статуса слова. Попробуйте позже.',
                code: 404,
            }
        }
    }
...
export function signIn(value) {
    return async (dispatch) => {
        try {
            ...
            dispatch(isBlock(false))
            return {
                text: 'Возникла проблема с входом на страницу. Попробуйте позже',
                code: 404,
            }
        }
    }
...
export function postSettings(name, value, token) {
    return async (dispatch) => {
        ...
        try {
            ...
            dispatch(isBlock(false))
            return {
                text: 'Возникла проблема с изменением настроек. Попробуйте позже',
                code: 404,
            }
        }
    }
...
export function uploadAvatar(file, token) {
    return async (dispatch) => {
        ...
        try {
            ...
            dispatch(isBlock(false))
            return {
                text: 'Возникла проблема с загрузкой вашего аватара. Попробуйте позже',
                code: 404,
            }
        }
    }
...
export function postName(name, token) {
    return async (dispatch) => {
        try {
            ...
            dispatch(isBlock(false))
            return {
                text: 'Возникла проблема с изменением вашего никнейма. Попробуйте позже',
                code: 404,
            }
        }
    }
...
export function postStats(token, gameName, correctArr, failArr, seriesArr) {
    return async (dispatch) => {
        ...
        try {
            ...
            dispatch(isBlock(false))
            return {
                text: 'Возникла проблема с отправкой вашей статистики. Статистика не обновлена',
                code: 404,
            }
        }
    }
