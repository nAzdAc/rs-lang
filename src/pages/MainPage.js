...
import { MANE_PAGE_TITLE, MANE_PAGE_TEXT_P1, MANE_PAGE_TEXT_P2,
  MANE_PAGE_TEXT_P3, MANE_PAGE_TEXT_P4, DEVELOPERS,
  ADVANTAGES } from '../constants/mainPage.constants';
...
const ManePage = () => {
  ...
  return (
    <div>
      ...
      <Typography variant='h3' className={classes.title}>{MANE_PAGE_TITLE}</Typography>
      <div className={classes.textImgWrapper}>
        <div>
          <Typography variant='body1' className={classes.text}>{MANE_PAGE_TEXT_P1}</Typography>
          <Typography variant='body1' className={classes.text}>{MANE_PAGE_TEXT_P2}</Typography>
          <Typography variant='body1' className={classes.text}>{MANE_PAGE_TEXT_P3}</Typography>
          <Typography variant='body1' className={classes.text}>{MANE_PAGE_TEXT_P4}</Typography>
        </div>
      ...
      <div className={classes.advantagesSection}>
        <Typography variant='h2' className={classes.title}>Ключевые преимущества</Typography>
      ...
      <div className={classes.developersSection}>
        <Typography variant='h2' className={classes.title}>Разработчики</Typography>
        <div className={classes.developers}>
            ...
            DEVELOPERS.map((developer, i) => {
              return (
                <div className={classes.developerWrapper} key={i} style={{order: `${i}`}}>
                  ...
                  <Typography className={classes.description} variant='body1'>{developer.description}</Typography>
          ...
          <div className={classes.developerWrapper} style={{order: '2'}}>
            <img className={classes.devImg} src={images.testimonial} alt='developer'/>
          </div>
        </div>
      </div>
    </div>
